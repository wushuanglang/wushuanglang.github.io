...
网站采用多页面结构设计，包含以下几个主要页面：

1. **个人简介** (`index.html`)：展示个人照片、姓名、职业和简短介绍
2. **工作经历** (`experience.html`)：以时间线形式展示工作经历
3. **技能展示** (`skills.html`)：使用进度条展示各种技能的熟练程度
4. **作品集** (`portfolio.html`)：展示个人项目作品
5. **联系方式** (`contact.html`)：展示联系信息并提供联系表单

每个页面都保持统一的导航侧边栏，方便用户在不同页面之间切换。
